...
function Intro() {
    ...
    return(
        <div  
        className=' w-full min-w-max md:w-full  flex flex-col items-center justify-center    shadow-xl shadow-slate-400 bg-gradient-to-bl from-blue-100 to-slate-500 '>
